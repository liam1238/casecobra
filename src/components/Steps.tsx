        ...
        <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
            {STEPS.map((step, i) => {
                ...
                return <li key={step.name} className="relative overflow-hidden lg:flex-1">
                    <div>
                        <span className={cn("absolute top-0 left-0 w-1 h-full bg-zinc-400 lg:top-auto lg:bottom-0 lg:h-1 lg:w-full", {
                        ...
                        <span className={cn(i !== 0 ? "lg:pl-9" : "", "flex items-center px-6 py-4 text-sm font-medium")}>
                            ...
                            <span className="ml-4 h-full flex mt-0.5 min-w-0 flex-col justify-center">
